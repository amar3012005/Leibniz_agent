...
Now used by both local and Docker implementations for consistency.

Reference:
    leibniz_agent/leibniz_intent_parser.py (lines 87-176) - Original pattern definitions
    leibniz_agent/services/intent/patterns.py - Microservice version
"""
...
def load_intent_patterns() -> Dict[str, Any]:
    """
    Load English-only intent patterns for fast classification.
    ...
    patterns = {
        ...
        # Exit patterns (expanded coverage)
        "exit": {
            "keywords": [
