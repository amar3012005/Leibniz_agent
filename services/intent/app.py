...
class ClassifyResponse(BaseModel):
    ...
    fast_route: bool = Field(..., description="True if pattern match, false if LLM fallback")
...
class MetricsResponse(BaseModel):
    ...
    total_requests: int
    fast_route_count: int
    gemini_route_count: int
    fast_route_percentage: float
...
app = FastAPI(
    ...
    description="Two-tier intent classification with pattern matching and LLM fallback",
    version="1.0.0",
    lifespan=lifespan
)
